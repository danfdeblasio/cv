...
\newcites{j,c,t,s,b,p}{Journal Publications,Conference Publications, Theses, Service Related Publication, Book, Posters}
...
\begin{itemize}[leftmargin=*,labelindent=5pt,itemindent=-15pt]
   ...
   $\cdot$~StringBio~2018 $\cdot$ Orlando, FL $\cdot$ October~2018
   \item ``Building an automated bioinformatician: More accurate, large-scale genomic discovery using parameter advising'' $\cdot$ ESCS~2018 $\cdot$ Athens, Greece $\cdot$ September~2018
    \item ``Building an automated bioinformatician: More accurate, large-scale genomic discovery using parameter advising'' $\cdot$ ISMB~2018 $\cdot$ Chicago, IL $\cdot$ July~2018
