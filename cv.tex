...
\begin{itemize}
    ...
    \item ``Advising multiple sequence alignments'' $\cdot$ ISCB Student Council Symposium 2014 $\cdot$  Boston, MA $\cdot$  2014.
...
\subparagraph{Reviewer} %Eighteen journal and seventy-seven conference submissions. 
\begin{itemize}
    \item \textbf{Journals} \ 
        Bioinformatics,
        PLOS One, 
