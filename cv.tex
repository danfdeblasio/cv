...
\usepackage{hyperref}
\hypersetup{
  pdftitle    = {Dan F. DeBlasio, PhD -- Curriculum Vitae},
  pdfauthor   = {Dan F. DeBlasio},
  pdfsubject  = {Curriculum Vitae},
  pdfkeywords = {computational biology, bioinformatics, machine learning, teaching, curriculum vitae},
}
...
\rfoot{\datestyle \monthyeardate\today{\color{white}. }}
...
\usepackage{sectsty}
\sectionfont{\LARGE\itshape\bfseries}
...
\newcites{m,j,c,t,s,b,p}{Highlight of Most Cited Papers, Technical Publications, Preprints/In Progress, Theses, Education Related Publication, Book, Posters}
...
%\end{tabular*}
{\noindent\namestyle Dan F. DeBlasio, PhD}\hfill
\shortstack[r]{dan@dandeblasio.com\\http://dandeblasio.com}
...
\vspace{-.75em}
\subparagraph{Assistant Teaching Professor} 08/2023--present
\begin{itemize}
    \item Ray and Stephanie Lane Computational Biology Department, School of Computer Science
\end{itemize}\vspace{-1em}

\subparagraph{Co-Assistant Director, Masters in Computational Biology} 08/2023--present
%\begin{itemize}
...
\subparagraph{Director, Integrated Master in Computational Biology} 05/2024--present
%\begin{itemize}
%    \item Ray and Stephanie Lane Computational Biology Department, School of Computer Science
%\end{itemize} 
\vspace{-1em}

\subparagraph{Lane Fellow}  9/2016--08/2019
\begin{itemize}
...
\vspace{-.75em}
\subparagraph{Assistant Professor}  08/2019--07/2023
\begin{itemize}
...
\subparagraph{Graduate Research Assistant} 8/2010--6/2016 
\begin{itemize}
...
\subsection*{Sanford-Burnham Institute for Medical Research, Orlando}
\vspace{-.75em}
\subparagraph{Research Associate II} 5/2010--8/2010 
%\begin{itemize}
%    \item Software development and data analysis of RNA-Seq and Chip-Seq experiments related to melanoma classification.
%\end{itemize}

\subsection*{University of Central Florida}
\vspace{-.75em}
\subparagraph{Graduate Research Assistant} 8/2007--8/2010 
\begin{itemize}
...
\subsection*{Cloudspace}
\vspace{-.75em}
\subparagraph{Developer} 8/2005--8/2007 
%\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\cvsection{Thesis Committee Contributions}
\subsection*{CMU}
\hspace{1.5em}\textbf{Kwanho Kim} \bigdot MSCB, 2019 

\textbf{Andrew Lutsky} \bigdot MSQBB, 2024 
...
\begin{itemize}
\item Last known position: Data Scientist at FDA
\end{itemize}

\textbf{Hector Richart Ruiz} November 2019--May 2022, BS Computer Science at UTEP
\begin{itemize}
\item Last known position: Factory Information Systems Engineer at Inventec
\end{itemize}
...
\textbf{Luis Cedillo} November 2021--August 2025, BS Computer Science at UTEP
\begin{itemize}
\item Last known position: PhD student at University of Connecticut 
\end{itemize}
...
\begin{itemize}
    \item Introduction to Computational Biology (02-250), Spring 2024, 2025, 2026\footnotemark[1]
    \item Algorithms and Advanced Data Structures (02-613/15-351/15-650), Spring 2024\footnotemark[1], 2025, 2026, Fall 2025
    \item Essentials of Mathematics and Statistics (02-680), Fall 2023\footnotemark[1], 2024, 2026
    \item Professional Issues for Computational and Automated Sciences (02-602/03-604), Fall 2023\footnotemark[1], 2024\footnotemark[1], 2025\footnotemark[1], 2026\footnotemark[1]
...
%%%%%%%%%%%%%%%%%%%%%%%%
\cvsection{Internal Service and Leadership Activities}
\subsection*{CMU}
  \begin{itemize}
...
\paragraph{National Science Foundation}  \hangindent=2em--- 
	...
	Role: PI --- Amount Awarded: \$10,000 (June 2025)
...
%%%%%%%%%%%%%%%%%%%%%%%%
\cvsection{Panel Participation/Organization}
\begin{itemize}%[leftmargin=*,labelindent=5pt,itemindent=-15pt]
  \item \textbf{ISMB 2026 \bigdot Washington, DC, USA} \bigdot~\textit{July~2026} \bigdot Participant \\ ``Computational Biology Career Opportunities in Industry and How to Prepare for Them!''  
...
\begin{itemize}%[leftmargin=*,labelindent=5pt,itemindent=-15pt]
  \item \textbf{Kingston University, Computer Science Department Seminar \bigdot London, UK} \bigdot~\textit{July 2025} \bigdot ``Computation for the real world: algorithmic solutions in space and biology''
...
\begin{itemize}
    \item Provosts Inclusive Teaching Fellowship (PITF), CMU Eberly Center, EY26
...
%%%%%%%%%%%%%%%%%%%%%%%%
\cvsection{External Service and Leadership Activities}

\subparagraph{International Society for Computational Biology}
\begin{itemize}
	\item Board of Directors (Student Council representative)  \bigdot 2017--2019
	\item Student Council Executive Team \bigdot 2017--2019
	\item Student Council Web Committee Co-chair \bigdot 2012-2017
\end{itemize}
...
\subparagraph{University of Arizona}
\begin{itemize}
	\item Associate Graduate Council for the College of Science (AGCCS) Computer Science Representative  \bigdot AY12
	\item Computer Science Graduate Student Council, Chair \bigdot AY11
	\item Computer Science Graduate Student Council, Volunteer Coordinator \bigdot AY10
	\item Science Salon, Co-Chair \bigdot AY11-AY12
\end{itemize}
%
...
\begin{itemize}
\item International Society for Computational Biology (ISCB), Senior Member
\item Association for Computing Machinery (ACM), ACM SIGBio, ACM SIGAct, ACM SIGCSE
...
\begin{itemize}%[leftmargin=!,labelindent=5pt,itemindent=-15pt]
    \item \textbf{Program Committee} \\ IEEE ICCABS 2017; RECOMB-SEQ 2020, 2021, 2022, 2024; ISMB(/ECCB) 2020, 2021, 2022, 2024, 2025, 2026; ACM-BCB 2022, 2026; ISCB-UK 2026; SIGCSE TS 2025, 2026
    ...
    \item \textbf{Travel Fellowships Co-Chair}\\ GLBIO 2024, 2025
\end{itemize}
...
\subparagraph{Conference/Workshop/Meeting Attendance}
\begin{itemize}
	...
	\item ESCS 2018
	\item FoCS 2009
	\item Global Bioinformatics Education Summit 2024, 25 
	\item ICML 2019
	...
	\item ISMB/ECCB 2011,13, 15, 17, 19, 21, 23, 25
	\item ISMB 2012, 14, 16, 18, 20, 22, 24, 26
	\item MAGE 2013
	\item NSF-NIH Joint Workshop in Emerging AI in Biology 2023
	\item RECOMB 2009, 12, 17, 19, 20, 21, 22, 26
