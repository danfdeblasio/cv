...
% Publications.
\bibliographystyleC{unsrt_custom_small}
%\bibliographystylec{unsrt_custom_small}
%\bibliographystyles{unsrt_custom_small}
%\bibliographystylet{unsrt_custom_small}
\bibliographystyleB{unsrt_custom_small}
%\bibliographystylep{unsrt_custom_small}
...
\begin{itemize}[leftmargin=*,labelindent=5pt,itemindent=-15pt]
  ...
  \item \textbf{Workshop on Automated Algorithm Design at TTI \bigdot~Chicago, IL} \bigdot~\textit{August~2019}% \bigdot~``Toward building an automated bioinformatician: more accurate transcript assembly via parameter advising''
  \item \textbf{Rutgers University, Camden \bigdot~Camden, NJ} \bigdot~\textit{April~2019} %\bigdot~``Toward building an automated bioinformatician: parameter advising for improved scientific discovery''
  \item \textbf{University of Texas at El Paso \bigdot~El Paso, TX} \bigdot~\textit{February~2019}%\bigdot~``Toward building an automated bioinformatician: parameter advising for improved scientific discovery''
...
%\end{itemize}
%
%\subparagraph{Executive Team}\hspace{1em}
